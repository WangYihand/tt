...
<body class="hold-transition skin-green-light sidebar-mini">
			...
			<section class="content">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
		              <li class="active"><a href="#tab_admin" data-toggle="tab" aria-expanded="true">权限表</a></li>
						...
						<div class="col-xs-12">
							<div class="box box-primary panel-default">
	    							...
	    							<div class="panel-body" style="padding: 0px;">
	    								<div class="box-body">
									<table id="powerList" data-toggle="table" data-search="true"
									data-search-align="left" data-query-params="queryParams"
									data-page-size="10" data-url="<%=request.getContextPath() %>/User/power/list"
									data-side-pagination="server" data-pagination="true">
									<thead>
										<tr>
											<th data-field="currentRow" data-align="center"></th>
											<th data-field="gname" data-align="center">角色</th>
											<th data-field="pname" data-align="center">权限</th>
											<th data-field="operate" data-align="center"
												data-formatter="powerListFormatter"
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/resources/js/user/power.js"></script>
</body>
</html>
